		...
		if enabled then
			...
			if getgenv().NotifMode == true then
				...
				game.StarterGui:SetCore(
					"SendNotification",
					{
						Title = "Firoxs dahood essentials",
...
--// variables etc
    ...
    local LoaderTitle = "Firoxs dahood essentials"
...
do
	...
	local IMGUIWindow = library:AddWindow("Firoxs dahood essentials", {
	...
	local silentAimbotTab = IMGUIWindow:AddTab("Rage")
    local espTab = IMGUIWindow:AddTab("Esp")
	local miscTab = IMGUIWindow:AddTab("Misc")
    local rageBot = IMGUIWindow:AddTab("Anti Aim")
	...
	do
		...
		local silenabled = silentAimbotTab:AddSwitch("Silent Aim",function(state)

			getgenv().SilentAimbot = state
		
		end)

       		silentAimbotTab:AddButton("Resolver", function()
...
RunService.Heartbeat:Connect(function()
    pcall(function()
		...
		local silenabled2 = silentAimbotTab:AddSwitch("Hit all Airshots",function(state)
		...
		local desync = rageBot:AddSwitch("Desync antilock", function(state)	
...
local underground = rageBot:AddSwitch("Underground antilock", function(state)	
getgenv().groundbot = state
getgenv().groundvalue = -350
game:GetService("RunService").heartbeat:Connect(function()
if getgenv().groundbot ~= false then
local antiurmum = game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity
game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity = Vector3.new(0, groundvalue, 0)
    game:GetService("RunService").RenderStepped:Wait()
    ...
    local skyaa = rageBot:AddSwitch("Sky antilock", function(state)	
getgenv().skybot = state
getgenv().skyvalue = 350
game:GetService("RunService").heartbeat:Connect(function()
if getgenv().skybot ~= false then
local antiurmum = game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity
game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity = Vector3.new(0, skyvalue, 0)
    game:GetService("RunService").RenderStepped:Wait()
    game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity = antiurmum
end
end)
    ...
    local trollaa = rageBot:AddSwitch("Troll AA", function(state)	
getgenv().trollbot = state

game:GetService("RunService").heartbeat:Connect(function()
if getgenv().trollbot ~= false then
local antiurmum = game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity
getgenv().trollvalue = math.random(350, -350)
game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity = Vector3.new(0, trollvalue, 0)
    game:GetService("RunService").RenderStepped:Wait()
    game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity = antiurmum
end
end)
		...
		miscTab:AddTextBox("speed", function(a)
